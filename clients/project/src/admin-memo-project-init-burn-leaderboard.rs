        ...
        Ok(signature) => {
            ...
            match client.get_account(&burn_leaderboard_pda) {
                Ok(account) => {
                    ...
                    println!("   📊 Will track top 100 projects by total burned tokens");
                    println!("   🚀 Projects will automatically enter leaderboard when creating projects or updating them");
                    println!("   🏆 Leaderboard will be updated in real-time during project creation and updates");
                },
                Err(e) => {

...
use anchor_client::{solana_sdk::{
    ...
    instruction::Instruction, compute_budget::ComputeBudgetInstruction,
}, Client};
...
fn main() {
    ...
    // Create a memo with at least 69 bytes of text
    let memo_text = "This is a memo with at least 69 bytes of text. Adding more text to reach the minimum length.";
    ...
    let compute_budget_ix = ComputeBudgetInstruction::set_compute_unit_limit(120_000);
    ...
    // Add the main ProcessTransfer instruction
    let tx = tx_builder
